    ...
    return (
        <Layout>
            <div className={styles.terms_and_conditions}>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to N.JY.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to N.JY, accessible from{' '}
                            <a href="https://www.niujingyi.com" rel="external nofollow noopener" target="_blank">
                                https://www.niujingyi.com
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <p>By email: njy.zoey@gmail.com</p>
                    </li>
                    <li>
                        <p>
